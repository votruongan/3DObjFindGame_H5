...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = '_HTML5ver_2.data';
    var REMOTE_PACKAGE_BASE = '_HTML5ver_2.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 44591072;
      var PACKAGE_UUID = '2c7f1a1a-7eae-489a-8e0f-7a94bfffb60b';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 41172046, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(41172046, 41172067, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(41172067, 41176687, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(41176687, 43688475, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(43688475, 44563447, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(44563447, 44591072, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile__HTML5ver_2.data');

    };
    Module['addRunDependency']('datafile__HTML5ver_2.data');
